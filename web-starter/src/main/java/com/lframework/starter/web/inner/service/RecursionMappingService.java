...
public interface RecursionMappingService extends BaseMpService<RecursionMapping> {
   ...
   * @return
   */
  List<RecursionMapping> getParentNodes(List<String> nodeIdList, Class<? extends NodeType> nodeTypeClazz);

  List<RecursionMapping> selectAll(Class<? extends NodeType> nodeTypeClazz);
   ...
   * @param nodeTypeClazz
   */
  void batchSaveNode(List<RecursionMapping> nodeList, Class<? extends NodeType> nodeTypeClazz);
   ...
   * @param nodeTypeClazz
   */
  void deleteBatchNode(List<String> nodeIdList, Class<? extends NodeType> nodeTypeClazz);
